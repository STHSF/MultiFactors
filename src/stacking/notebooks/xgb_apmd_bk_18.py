...
alpha_factor_store = {'alpha_1': LAST('alpha_1'), 'alpha_2': LAST('alpha_2'), 'alpha_3': LAST('alpha_3'),
...
# 约束条件比较宽松
# tune_record.to_sql('tune_record__whole_loose', con=con, if_exists='append', index=False)
